	...
	async.auto({
		...
		getPost: ['getRedis', function(results, callback) {
			if(results.getRedis){
				...
				logger.info(typeof obj.header);
				logger.info(obj.header);
				...
				if(type=="post"){
					...
					request.post({
						url: obj.host!=undefined ? obj.host+obj.url : config.servers.host+obj.url,
						body: obj.data,
						json: true,
						headers: obj.header!=undefined ? obj.header : config.servers.headers
					}, function (error, response, body) {
					...
					request.get({
						...
						/*headers: {
							...
							'TOKEN': 'eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiJqd3QiLCJzdWIiOiJ7XCJjcmVhdGVEYXRlXCI6XCIxNDkwNzY2NDA5MDU5XCIsXCJtb2JpbGVDb2RlXCI6XCIxNTg4Mjg4ODM5N1wiLFwib2JqZWN0SWRcIjpcIjE0NjgwOFwiLFwicm9sZUlkXCI6XCJcIn0iLCJleHAiOjE0OTA3NjY0MTYyNTksImlzcyI6InN4ankifQ.xlv94XDB3LpRR5v_lx_s_exA6OGfRVG8XlvPqRiNFOI'
						},*/
						qs: obj.data
					}, function (error, response, body) {
